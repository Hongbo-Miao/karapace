...
from .backend import BaseItemsBackupReader, BaseKVBackupProducer
...
class SchemaBackupV2Producer(BaseKVBackupProducer):
    @staticmethod
...
class AnonymizeAvroProducer(BaseKVBackupProducer):
    @staticmethod
    def serialize_record(
        key_bytes: bytes | None,
        value_bytes: bytes | None,
